...
def run_lloyd_gla(num_of_elements, variance_of_samples, initial_alphabet_opt, distortion_measure_opt, num_of_samples, max_num_of_interactions, results_dir, instance_id, percentage_of_sub_samples, samples_random_seed, trial_random_seed):
    ...
    #variance_of_samples = variance_of_samples
    #initial_alphabet_opt = initial_alphabet_opt
    #distortion_measure_opt = distortion_measure_opt
    #num_of_samples = num_of_samples
    #max_num_of_interactions = max_num_of_interactions
    #percentage_of_sub_samples = percentage_of_sub_samples
    #samples_random_seed = samples_random_seed
    #trial_random_seed = trial_random_seed
