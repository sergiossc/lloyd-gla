...
#max_squared_norm = -np.Inf
#max_squared_norm_sample = np.zeros((num_rows, num_cols), dtype=complex)
for s in samples:
    print (f'sample shape: {np.shape(s)}')
#    s_squared_norm = squared_norm(s)
#    if s_squared_norm > max_squared_norm:
#        max_squared_norm = s_squared_norm
#        max_squared_norm_sample = s
#print ('max_squared_norm: ', max_squared_norm)
#print ('sample who has max norm: \n', max_squared_norm_sample)
